...
//from a text document that represent spacecraft masses
//and figures out the amount of fuel needed for all of the spacecrafts
//and adds them all up, displaying the resulting sum.
